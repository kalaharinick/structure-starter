...
export const Hero = () => {
  const featuredProducts = [
    {
      ...
      gradient: "from-[hsl(var(--juice-yellow))] to-[hsl(var(--juice-orange))]"
    },
    {
      image: orangeJuiceHero,
      title: "100% Tangerine Orange",
      subtitle: "Fresh & Vitamin Rich",
      gradient: "from-[hsl(var(--juice-orange))] to-[hsl(var(--juice-green))]"
    },
    {
      image: watermelonJuiceHero,
      title: "Cold Pressed Watermelon",
      subtitle: "Refreshing & Natural",
      gradient: "from-[hsl(var(--juice-red))] to-[hsl(var(--accent))]"
    }
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[hsl(var(--juice-green))] via-[hsl(var(--juice-orange))] to-[hsl(var(--juice-red))] opacity-10" />
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-[hsl(var(--juice-green))] via-[hsl(var(--juice-orange))] to-[hsl(var(--juice-red))] bg-clip-text text-transparent leading-tight">
            Fresh Juice
            <br />
            From The Heart
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-[hsl(var(--juice-orange))] to-[hsl(var(--juice-yellow))] hover:opacity-90 transition-opacity text-lg px-8 py-6"
            >
              Shop Now
            </Button>
            <Button 
